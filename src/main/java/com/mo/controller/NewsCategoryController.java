...
import com.mo.model.NewsCategory;
import com.mo.model.ResObject;
import com.mo.service.NewsCategoryService;
import com.mo.util.Constant;
import com.mo.util.PageUtil;
...
public class NewsCategoryController {
	...
	public String newsCategoryMange(NewsCategory newsCategory,@PathVariable Integer pageCurrent,@PathVariable Integer pageSize,@PathVariable Integer pageCount,Model model) {
	...
	public String newsCategoryEditPost(Model model,NewsCategory newsCategory,@PathVariable MultipartFile[] imageFile,HttpSession httpSession) {
